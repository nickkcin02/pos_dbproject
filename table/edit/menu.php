      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-2" style="margin-top: 20px" align="right">
               <a href="../welcome/?test=12"><button type="button" class="btn btn-success" style=" margin-top: 40px;" >Add New Menu</button></a>
          </div>
          <div class="col-sm-1"></div>
            <div class="col-sm-1"></div>
            <div class="col-sm-8" style="margin-top: 20px" >
        ...
        <div class="col-sm-10">
          <table id="myTable" class="table-striped table-bordered">
            <tr class="header">
              ...
              <th style="width:30%;"><center>Amount</center></th>
            </tr>
            <?php  
    ...
    // <input type="checkbox" id="'. $row["name"].'" name="'. $row["name"].'" value="'. $row["name"].'">
            ...
            if (mysqli_num_rows($result) > 0) {
              while($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td><a href="../welcome/?test=12&id='.$row["ID"].'"><button type="button" class="btn btn-success" style=" width: 150px" >Edit Menu</button></a><button type="button" class="btn btn-danger" style=" width: 150px" onclick="deleteMenu('.$param.')">Delete Menu</button> </td>';
                echo "</td>";
                echo "</tr>";
              }
            } 
...
<script>
  ...
  function deleteMenu(id,name){
   ...
   swal({
     title: "#Delete "+name,
     text: "คุณต้องการลบ ข้อมูลการสั่งอาหาร โปรโมชั่นรวมไปถึง",
     icon: "warning",
     buttons: true,
     dangerMode: true,
   }).then((resp) => {
